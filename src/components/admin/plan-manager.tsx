...
export function PlanManager({ initialPlans }: PlanManagerProps) {
  ...
  function startEdit(plan: Plan) {
    ...
    setCycle(knownCycle);
    setDurationDays(
      String(plan.duration_days ?? PRESET_DAYS[plan.cycle] ?? 30),
    );
        ...
        >
          <div>
            ...
            <p className="text-zinc-500 text-xs">
              ...
              {plan.duration_days ?? PRESET_DAYS[plan.cycle] ?? 30} dias)
            </p>
          </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  const matchingPreset = Object.entries(PRESET_DAYS).find(
                    ([, d]) => d === e.target.value,
                  );
                  if (matchingPreset) {
